...
Scenario Outline: Mapping
	...
	| xml-xml-xml-xml-null-null           | Xml   | <root><testItem>value</testItem></root> | xml               | ./testItem            | xml       | xml                    | xml          | null              | null              | XML#24, XML#2, XML#2, TREE#11, TREE#12                                           | <nullObject /> |
	| xml-xml-xml-xml-xml-xml             | Xml   | <root><testItem>value</testItem></root> | xml               | ./testItem            | xml       | xml                    | xml          | xml               | xml               | XML#24, XML#2, XML#2, XML#4, XML#7                                               | <nullObject /> |
