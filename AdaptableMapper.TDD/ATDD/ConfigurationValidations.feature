...
Scenario Outline: Mapping
	...
	| xml-xml-xml-xml-null-null           | Xml   | <root><testItem>value</testItem></root> | xml               | ./testItem            | xml       | xml                    | xml          | null              | null              | XML#24, XML#2, XML#2, XML#26, XML#11, TREE#11, TREE#12                           | <nullObject /> |
	| xml-xml-xml-xml-xml-xml             | Xml   | <root><testItem>value</testItem></root> | xml               | ./testItem            | xml       | xml                    | xml          | xml               | xml               | XML#24, XML#2, XML#2, XML#26, XML#11, XML#4, XML#7                               | <nullObject /> |
	| json-json-null-null-null-null       | Json  | { "testItem": [ {"item": "value"} ]}    | json              |                       | json      | null                   | null         | null              | null              | TREE#9, TREE#10, JSON#26                                                         | {}             |
	| json-json-json-json-null-null       | Json  | { "testItem": [ {"item": "value"} ]}    | json              | .testItem             | json      | json                   | json         | null              | null              | JSON#26, JSON#24, JSON#1, TREE#11, TREE#12                                       | {}             |
	| json-json-json-json-json-json       | Json  | { "testItem": [ {"item": "value"} ]}    | json              | .testItem             | json      | json                   | json         | json              | json              | JSON#26, JSON#24, JSON#1, JSON#11, JSON#19                                       | {}             |
