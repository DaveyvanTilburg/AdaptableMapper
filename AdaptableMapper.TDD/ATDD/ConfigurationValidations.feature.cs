...
#line hidden
        ...
        [Xunit.InlineDataAttribute("json-json-json-json-json-json", "Json", "{ \"testItem\": [ {\"item\": \"value\"} ]}", "json", ".testItem", "json", "json", "json", "json", "json", "JSON#26, JSON#24, JSON#1, JSON#6, JSON#11, JSON#19", "{}", new string[0])]
