...
#line hidden
        ...
        [Xunit.InlineDataAttribute("Xml-Json-Json", "Xml", "Json", "Json", "e-XML#31;e-JSON#26;", "{}", new string[0])]
...
#line hidden
        ...
        [Xunit.InlineDataAttribute("xml-xml-xml-xml-null-null", "Xml", "<root><testItem>value</testItem></root>", "xml", "./testItem", "xml", "xml", "null", "null", "e-XML#24;e-XML#27;e-TREE#11;e-TREE#12;", "<nullObject />", new string[0])]
        [Xunit.InlineDataAttribute("xml-xml-xml-xml-xml-xml", "Xml", "<root><testItem>value</testItem></root>", "xml", "./testItem", "xml", "xml", "xml", "xml", "e-XML#24;e-XML#27;e-XML#29;w-XML#7;", "<nullObject />", new string[0])]
        ...
        [Xunit.InlineDataAttribute("json-json-json-json-json-json", "Json", "{ \"testItem\": [ {\"item\": \"value\"} ]}", "json", ".testItem", "json", "json", "json", "json", "e-JSON#26;e-JSON#9;e-JSON#1;e-JSON#6;e-JSON#19;", "{}", new string[0])]
