...
#line hidden
        ...
        [Xunit.InlineDataAttribute("xml-xml-xml-xml-xml-xml", "Xml", "<root><testItem>value</testItem></root>", "xml", "./testItem", "xml", "xml", "xml", "xml", "xml", "XML#24, XML#2, XML#2, XML#26, XML#11, XML#4, XML#7", "<nullObject />", new string[0])]
