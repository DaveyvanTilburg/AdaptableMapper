...
Scenario Outline: MappingConfiguration
	...
	| DataStructure-Xml-Xml            | DataStructureBase             | Xml                           | Xml             | e-XML#24;e-DataStructure#17;e-TREE#7;e-TREE#9;e-TREE#10;  | <nullElement /> |
	| Json-DataStructure-DataStructure | Json                          | DataStructure                 | DataStructure   | e-JSON#13;e-DataStructure#25;e-TREE#7;e-TREE#9;e-TREE#10; | {}              |
...
Scenario Outline: Mapping
	...
	| json-json-json-json-null-null                                                       | Json          | { "testItem": [ {"item": "value"} ]}    | json              | .testItem             | json                   | json          | null              | null              | e-JSON#26;e-JSON#9;e-JsonChildCreator#1;e-JsonChildCreator#3;e-TREE#11;e-TREE#12; | {}              |
	| json-json-json-json-json-json                                                       | Json          | { "testItem": [ {"item": "value"} ]}    | json              | .testItem             | json                   | json          | json              | json              | e-JSON#26;e-JSON#9;e-JsonChildCreator#1;e-JsonChildCreator#3;e-JSON#6;e-JSON#19;  | {}              |
	| DataStructure-DataStructure-null-null-null-null                                     | DataStructure | { "Items": [{ "Items": []}]}            | DataStructure     |                       | null                   | null          | null              | null              | e-TREE#9;e-TREE#10;e-DataStructure#25;                                            | {}              |
	| DataStructure-DataStructure-DataStructure-DataStructure-null-null                   | DataStructure | { "Items": [{ "Items": []}]}            | DataStructure     | /Items                | DataStructure          | DataStructure | null              | null              | e-DataStructure#25;e-TREE#11;e-TREE#12;w-DataStructure#7;                         | {}              |
	| DataStructure-DataStructure-DataStructure-DataStructure-DataStructure-DataStructure | DataStructure | { "Items": [{ "Items": []}]}            | DataStructure     | /Items                | DataStructure          | DataStructure | DataStructure     | DataStructure     | e-DataStructure#25;w-DataStructure#7;w-DataStructure#9;                           | {}              |